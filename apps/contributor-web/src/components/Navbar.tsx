...
const Navbar = async () => {
  ...
  return (
    <nav className="  bg-gradient-to-r from-[#FCE184] via-[#FFB877] to-[#FCE184] text-[#FEF8E2] p-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-x-4 animate-fade-in-up">
          {!session ? (
            <button
              type="button"
              className="text-[#f1f1f1] bg-gradient-to-r  from-[#000000] to-[#432e6d] hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-[#8e2de2] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
            >
